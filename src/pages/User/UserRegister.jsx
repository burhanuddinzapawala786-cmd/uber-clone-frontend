...
const user = {
 ...
 try {
   const response = await axios.post(`${import.meta.env.VITE_BASE_URL}register/user` , user);
   ...
   if(response.status===201){
        ...
        setErrorMessage('We could not create your account.');
   ...
   if (err.code === 'ERR_NETWORK' || err.message === 'Network Error') {
     ...
     setErrorMessage(err.response?.data?.message || 'Please fill in all the required details correctly.');
     setErrorType('register');
   }
 }
}}>
